...
import type { BloqueioGeneral } from "@/bloqueios"
...
export default function BloqueiosGeneralesPage() {
  const [bloqueios, setBloqueios] = useState<BloqueioGeneral[]>([])
  ...
  async function carregarBloqueios() {
    ...
    if (error) {
      console.error(error)
      alert("Erro ao carregar bloqueios gerais")
    } else {
      setBloqueios((data || []) as BloqueioGeneral[])
    }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-white">
              Bloqueios generales 🗓️
            </h1>
            <p className="text-white/80 mt-2">
              Gerencie feriados, pausas gerais e dias em que nenhuma clínica deve atender.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 mb-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-[#026A6A]">
              Nuevo bloqueo general
            </h2>
            <p className="text-sm text-gray-500 mt-1">
              Use esta tela para bloquear datas gerais da fundação, como feriados ou pausas de atendimento.
            </p>
          </div>
          ...
          <form onSubmit={criarBloqueio} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Ex.: Feriado nacional, pausa da fundação..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Descreva o motivo do bloqueio geral"
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 mb-8">
          ...
          <div className="mt-5 flex flex-wrap gap-4 text-xs">
            <div className="flex items-center gap-2">
              ...
              <span>Día com bloqueio general</span>
            </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Visualize, ative, desative ou exclua os bloqueios gerais já registrados.
            </p>
          </div>
